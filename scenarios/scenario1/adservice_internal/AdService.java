...
public final class AdService {
  ...
  public static void emitLog(String event, String logLevel) {
    ...
    String now = instant.toInstant().toString();
    String timestamp = now.substring(0, now.length() - 7);
  ...
  private static class AdServiceImpl extends hipstershop.AdServiceGrpc.AdServiceImplBase {
    ...
    public void getAds(AdRequest req, StreamObserver<AdResponse> responseObserver) {
      ...
      try {
        ...
        // Throw an exception and see frontend reaction
        if (ServiceName.toString().equals("frontend")) {
